...
const Loading = () => {
  return (
    <div className="h-full">
      ...
      <div className="h-full">
      <div className="hidden md:flex h-full w-60 flex-col absolute inset-y-0 z-0 top-0 left-[72px]">
      ...
      <div className="h-full md:absolute z-0 top-0 left-[312px] w-[calc(100%-312px)]">
